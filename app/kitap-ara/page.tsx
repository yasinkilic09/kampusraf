...
function getSafeCondition(value: string) {
  return ["yeni", "temiz", "az_kullanilmis", "orta", "yipranmis"].includes(value)
    ? value
    : "";
}
...
function LockedFeatureCard({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-[#F59E0B]/30 bg-[#F59E0B]/5 p-4">
...
export default async function SearchBooksPage({
  ...
  const rawExchangeType = getSafeExchangeType(params.exchange_type?.trim() || "");
          ...
          <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-white/75 md:text-base">
                Paketine göre şehir, üniversite, paylaşım türü, kitap durumu,
                eşleşme tercihi ve akıllı sıralama özelliklerini kullan.
              </p>
            </div>
          ...
          <div className="grid gap-3 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.7fr]">
            <div>
              ...
              <p className="mt-2 text-xs font-semibold text-slate-400">
                Free pakette açık. Kitap adı, yazar veya kategoriyle arama yap.
              </p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                disabled={!canUseLocationFilters}
                placeholder={
                  canUseLocationFilters ? "ADÜ, Adnan Menderes..." : "Plus ile açılır"
                }
                className="mt-2 w-full rounded-2xl border border-slate-200 bg-[#FAF7F0] px-4 py-3 text-sm outline-none transition focus:border-[#2E7D5B] focus:bg-white disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400"
              />
            </div>
